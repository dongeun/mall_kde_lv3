...
public class PolicyHandler{
    ...
    public void wheneverOrderCanceled_DeliveryCanced(@Payload OrderCanceled orderCanceled){

        OrderCanceled event = orderCanceled;
        System.out.println("\n\n##### listener DeliveryCanced : " + orderCanceled + "\n\n");


        

        // Sample Logic //
        Delivery.deliveryCanced(event);
